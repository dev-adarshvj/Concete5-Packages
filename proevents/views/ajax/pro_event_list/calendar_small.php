...
print "<tr>";
print "<th class='select'><span onClick=\"prev_month();\" class=\"button\"><span class=\"ui-icon ui-icon-circle-triangle-w\"></span></span></th>";
...
while ($day_num <= $days_in_month) {
    ...
    if ($ei == true) {
        ...
        print '<div class="' . $itemstyle . ' daynum hasevent">';
        print '<a  href="javascript:;" onClick="loadMyDialogDo(\'' . $day_num . '\');">';
        print $day_num;
        print '</a>';
        print '<div  class="myDialogContent' . $day_num . ' popup_events" style="display: none;">';
        ...
        print $day_num;
        print '<div  class="myDialogContent' . $day_num . '" style="display: none;">';
    }
