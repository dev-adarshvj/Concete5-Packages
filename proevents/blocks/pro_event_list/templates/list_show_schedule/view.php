...
if ($c->isEditMode()) {
    echo '<i style="color: orange;max-width: 400px;display: block;">' . t(
            'Don\'t forget, you can quickly change this to Calendar view by clicking on this area, and selecting "Custom Template". <br/> Also, if you want to view date sets in "blocks" instead of a listing for each date, try using the standard Page List block and changing the Custom Template to the "Special Events" template.'
        ) . '</i>';
}
                    ...
                    <div class="infowrap">
                        <div class="titlehead">
                            ...
                            <div class="title">
                                ...
                                <?php   echo date(t('d.m.y'), strtotime($date)); ?>
                                - <?php   echo '<a href="' . $url . '?eID=' . $eID . '">' . $title . '</a>'; ?>
                            </div>
                            <div class="local">
                                <?php  
                                if ($address != '') {
