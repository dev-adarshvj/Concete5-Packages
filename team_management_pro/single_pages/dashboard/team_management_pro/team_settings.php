...
<form method="post" class="form-horizontal"  id="settings-form" action="<?php echo $this->action('save_settings');?>">
    ...
    <div class="row">
      <div class="form-group">
        ...
        <div class="col-sm-7">
          <div class="input-group">
          <?php if(sizeof($attribute_sets)>0){ ?>
      <?php echo $form->select('TEAM_MANAGEMENT_COLLECTION_TYPE_ID',$pageTypes,$page_type_id)?>
      <?php }else { 
  ...
  <div class="ccm-dashboard-form-actions-wrapper">
    <div class="ccm-dashboard-form-actions"> <a href="<?php echo View::url('/dashboard/team_management_pro/list')?>" class="btn btn-default pull-left"><?php echo t('Cancel')?></a> <?php echo Loader::helper("form")->submit('add', 'Save Settings', array('class' => 'btn btn-primary pull-right'))?> </div>
  </div>
